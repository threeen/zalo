...
function attr(elem, prop, value) {
	...
	if (isString(prop)) {
		...
		// get the value
		} else if (elem && elem.getAttribute) { // elem not defined when printing pie admin...
		...
		return extend(clipRect, {
			...
			updateClipping: function () {
				each(clipRect.members, function (member) {
					if (member.element) { // Deleted series, like in stock/members/series-remove admin. Should be removed from members, but this will do.
